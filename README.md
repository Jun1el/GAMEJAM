...
| Caminar en sigilo | `Shift` (Izquierdo o Derecho) |
...
### Firulais (Perros Callejeros) 🐕

De 3 a 5 perros callejeros de la universidad aparecerán durmiendo plácidamente (indicados con una "Zzz") a lo largo de los pasillos.
- **Caminar con Sigilo:** Si usas la tecla `Shift` podrás reducir tu velocidad para no molestarlos y pasar de forma segura por su lado.
